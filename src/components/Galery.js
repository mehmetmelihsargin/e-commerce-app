    ...
    <div class="px-5 py-2 mx-auto lg:pt-24 lg:px-32">
      <div class="flex flex-wrap -m-1 md:-m-2">
        <div class="flex flex-wrap w-1/2">
          <div class="w-1/2 p-1 md:p-2 text-3xl text-black hover:text-5xl flex items-center justify-center">
          ...
          <div class="w-full p-1 md:p-2 text-3xl text-black hover:text-5xl flex items-center justify-center">
            <h1 className=" p-10  rounded-xl absolute hover:hidden cursor-pointer">Electronics</h1>
            <img alt="gallery" class="block opacity-40 opacity-40 object-cover object-center w-full h-full rounded-lg"
